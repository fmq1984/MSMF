...
indoor3d_data_dir = os.path.join(data_dir, 'Vaihingen3D_Training')
NUM_POINT = 4096
H5_BATCH_SIZE = 100
...
output_dir = os.path.join(data_dir, 'Vaihingen3D_Training_hdf5_data')
...
for i, data_label_filename in enumerate(data_label_files):
    ...
    data, label = indoor3d_util.room2blocks_wrapper_normalized(data_label_filename, NUM_POINT, block_size=10.0, stride=10.0,
